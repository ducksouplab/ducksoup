...
const ducksoupListener = (options) => (message) => {
  ...
  if (kind === "start") {
    ...
    if (payload && payload[state.userId]) {
      let html = "The test just finished. Were you able to hear yourself correctly without background noise? If you did, you can participate in the experiment. If not then you are not allowed to participate in the experiment. Please return your prolific submission using <a href=\"https://app.prolific.com/submissions/complete?cc=C1A9QE6C\">this link</a>.";
